                    ...
                    <div class="html_content">
                        <p><span class="ttr_image"
                                style="float:none;display:block;text-align:center;overflow:hidden;margin:0em 0em 0em 0em;"><span><img
                                        ...
                                        style="max-width:300px;max-height:300px;"></span></span></p>
                    </div>
                    <div style="height:0px;width:0px;overflow:hidden;-webkit-margin-top-collapse: separate;"></div>
                    <div style="clear:both;"></div>
                </div>
                ...
                <div class="ttr_Training_html_column11">
                    ...
                    <div class="html_content">
                        ...
                        <p style="margin:0.71em 0em 0.36em 0em;"><span
                                style="font-family:'Arial';font-weight:700;color:rgba(231,76,60,1);">OCTOBER 20, 2015</span>
                        </p>
                        <p style="margin:1.43em 0em 0.36em 0em;line-height:1.76056338028169;"><span
                                style="color:rgba(5,38,55,1);">G</span><span style="color:rgba(5,38,55,1);">ravida vehicula,
                                nisl.Praesent mattis, massa quis</span><span style="color:rgba(5,38,55,1);">.</span><span
                                style="color:rgba(5,38,55,1);"> luctus fermentum, turpis mi volutpat justo, eu volutpat enim
                                ...
                                style="color:rgba(5,38,55,1);"> luctus fermentum, turpis mi volutpat justo</span><span

...
if($recorrencia == 'Sim'){
    ...
    $pdo->query("INSERT INTO receber SET cliente = '$cliente', referencia = '$recorrencia', id_ref = '$id_ref', valor = '$valor', parcela = '$nova_parcela', usuario_lanc = '0', data = curDate(), data_venc = '$novo_vencimento', pago = 'Não', descricao = '$descricao', frequencia = '$dias_frequencia', recorrencia = 'Sim' ");
}
